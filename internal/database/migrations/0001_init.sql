...
-- Canonical scammer entity + linked identifiers (username-change resistant).
...
-- 4. Reports — user submissions awaiting admin review. Raw target fields are
--    preserved as submitted; scammer_id links to the resolved canonical entity.
...
-- The UNIQUE (kind, value) constraint already serves as the primary lookup
-- index; the following cover secondary access patterns.
